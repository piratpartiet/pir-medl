...
#=======================================================================
# installed_progs.t
# File ID: a8147dd0-38c4-11e7-97b3-f74d993421b0
#
...
=cut
    ...
    # factor false fmt fold groups head hostid id install join kill link ln 
    # logname ls md5sum mkdir mkfifo mknod mktemp mv nice nl nohup nproc numfmt 
    # od paste pathchk pinky pr printenv printf ptx pwd readlink realpath rm 
    # rmdir runcon seq sha1sum sha224sum sha256sum sha384sum sha512sum shred 
    # shuf sleep sort split stat stdbuf stty sum sync tac tail tee timeout 
